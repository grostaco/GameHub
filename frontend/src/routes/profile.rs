...
pub fn profile() -> Html {
    ...
    let user_info = use_async_with_options(
        async move { get_user_info(jwt.access_token.as_str()).await },
        ...
        if let Some(user_info) = &user_info.data {
            <div class="form-container" style="justify-content: center; margin-top: 1.5rem;">
                ...
                <div class="dflex dflex-justify-center dflex-gap-sm">
                    <h3>{"About Me"}</h3>
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 494.936 494.936" fill="white" stroke="white" stroke-width="10">
                    <g>
                        <g>
